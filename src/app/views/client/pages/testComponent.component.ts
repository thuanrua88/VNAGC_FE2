          ...
          <tbody>
            <tr>
              <td class="sm-px-24"
                ...
                <a href="https://4TĐ.com?verification_url"
                  style="display: block; font-size: 14px; line-height: 100%; margin-bottom: 24px; --text-opacity: 1; color: #7367f0; color: rgba(115, 103, 240, var(--text-opacity)); text-decoration: none;">https://4TĐ.com?verification_url</a>
            ...
            <tr>
              <td
                ...
                <p style="--text-opacity: 1; color: #263238; color: rgba(38, 50, 56, var(--text-opacity));">
                  ...
                  <a href="https://4TĐ.com/" class="hover-underline"
